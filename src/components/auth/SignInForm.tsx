...
import { Utensils, Eye, EyeOff, ArrowLeft, ArrowRight, ChevronRight } from "lucide-react";
...
export function SignInForm({ restaurantName = "Swiftab" }: AdminSignInFormProps) {
  ...
  useEffect(() => {
    if (signInMutation.isSuccess) {
      toast({
        title: "Welcome Back!",
        description: "You've successfully logged into your restaurant management dashboard.",
        variant: "default",
      });
    ...
    <div className="w-full max-w-4xl mx-auto flex flex-col items-center p-8 bg-white rounded-lg shadow-lg">
      ...
      <div className="w-full max-w-md">
        <div className="flex items-center justify-center gap-3 mb-6">
          <Utensils className="h-8 w-8 text-teal-600" style={{ color: "#008080" }} />
          ...
          {({ isSubmitting }) => (
            <Form className="space-y-5">
              <div className="space-y-2">
                <Label htmlFor="email" className="text-gray-700 font-medium">Administrator Email</Label>
              ...
              <div className="text-center text-xs text-gray-500 mt-4">
                <p>Need support? Contact <a href="mailto:support@restaurant.com" className="text-teal-700 hover:underline" style={{ color: "#008080" }}>support@restaurant.com</a></p>
              </div>
            </Form>
          )}
        </Formik>
