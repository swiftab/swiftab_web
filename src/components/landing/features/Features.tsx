...
const features = [
  {
    ...
    description: "Design your restaurant layout with intuitive tools and templates.",
    image: "/user.png",
  ...
  },
  {
    ...
    description: "Optimize your workflow with our integrated management system.",
    image: "/user.png",
  ...
  },
  {
    ...
    description: "Manage bookings seamlessly with our advanced reservation system.",
    image: "/user.png",
...
function FeatureCard({ feature, progress, index, total }: FeatureCardProps) {
  ...
  return (
    ...
    >
      <div className={`${feature.bgColor} backdrop-blur-lg rounded-3xl shadow-xl w-full max-w-4xl h-[80vh] flex overflow-hidden`}>
